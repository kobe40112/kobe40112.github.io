...
function MemberMyFiles(props) {
  ...
  const [CustomerUsernameMassage, setCustomerUsernameMassage] = useState('')
    ...
    <>
        ...
        <div className="form-row">
          ...
          <div className="col-md-4">
            <input
              ...
              placeholder="請決定你的暱稱"
              className={
                CustomerUsernameMassage ? 'form-control is-invalid' : 'form-control'
              }
              onChange={(event) => {
          ...
          {CustomerUsernameMassage ? (
            <div class="invalid-feedback">{CustomerUsernameMassage}</div>
          ) : (
            ''
          )}
        </div>
      ...
      <button
        ...
        onClick={() => {
          ...
          if (!CustomerUsername) {
            setCustomerUsernameMassage('暱稱欄位不能空白。')
            correct = false
          } else {
            setCustomerUsernameMassage('')
          }
    ...
    <>
      <Router>
        ...
        <Modal
          ...
          centered
        >
          <Modal.Header closeButton style={{ color: '#57493A' }}>
            <Modal.Title>哈囉！</Modal.Title>
          </Modal.Header>
          <Modal.Body style={{ textAlign: 'center', color: '#796A60', fontSize: '1.25rem' }}>
            {modalWord}
          </Modal.Body>
          <Modal.Footer>
            <Button
